...
/* Generated by Opal 0.7.1 */
Opal.modules["board.rb"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  ...
  Opal.add_stubs(['$attr_accessor', '$merge', '$grid=', '$new', '$[]', '$each', '$[]=', '$+', '$each_with_index', '$to_s', '$-', '$==', '$%', '$include?', '$nil?', '$grid', '$!', '$pos=', '$select', '$color', '$compact', '$flatten', '$validate_move', '$move!', '$is_a?', '$raise', '$moves', '$class', '$all?', '$exit', '$dup', '$pos', '$in_check?', '$find', '$pieces', '$any?', '$other_color', '$<=', '$count', '$empty?']);
  return (function($base) {
    var self = $module($base, 'Chess');
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(options) {
        var $a, $b, $c, $d, TMP_1, TMP_3, self = this, default_options = nil;

        if (options == null) {
          options = $hash2([], {})
        }
        default_options = $hash2(["blank"], {"blank": false});
        options = default_options.$merge(options);
        (($a = [($c = ($d = $scope.get('Array')).$new, $c.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a, $b, TMP_2;

        return ($a = ($b = $scope.get('Array')).$new, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

          return nil}, TMP_2.$$s = self, TMP_2), $a).call($b, 8)}, TMP_1.$$s = self, TMP_1), $c).call($d, 8)]), $b = self, $b['$grid='].apply($b, $a), $a[$a.length-1]);
        if ((($a = options['$[]']("blank")) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
        return ($a = ($b = [["white", 7, 6], ["black", 0, 1]]).$each, $a.$$p = (TMP_3 = function(color, r, pawn_r){var self = TMP_3.$$s || this, $a, $b, TMP_4;
if (color == null) color = nil;if (r == null) r = nil;if (pawn_r == null) pawn_r = nil;
        self['$[]='](r, 0, $scope.get('Rook').$new(self, color));
          self['$[]='](r, 1, $scope.get('Knight').$new(self, color));
          self['$[]='](r, 2, $scope.get('Bishop').$new(self, color));
          self['$[]='](r, 3, $scope.get('Queen').$new(self, color));
          self['$[]='](r, 4, $scope.get('King').$new(self, color));
          self['$[]='](r, 5, $scope.get('Bishop').$new(self, color));
          self['$[]='](r, 6, $scope.get('Knight').$new(self, color));
          self['$[]='](r, 7, $scope.get('Rook').$new(self, color));
          return ($a = ($b = ($range(0, 8, true))).$each, $a.$$p = (TMP_4 = function(c){var self = TMP_4.$$s || this;
if (c == null) c = nil;
          return self['$[]='](pawn_r, c, $scope.get('Pawn').$new(self, color))}, TMP_4.$$s = self, TMP_4), $a).call($b);}, TMP_3.$$s = self, TMP_3), $a).call($b);
      };

      def.$to_s = function(options) {
        var $a, $b, TMP_5, self = this, default_options = nil, result = nil;

        if (options == null) {
          options = $hash2([], {})
        }
        default_options = $hash2(["cursor_pos", "moves"], {"cursor_pos": nil, "moves": []});
        options = default_options.$merge(options);
        result = "\e[H\e[2J";
        result = result['$+']("  a b c d e f g h\n");
        ($a = ($b = self.$grid()).$each_with_index, $a.$$p = (TMP_5 = function(row, r){var self = TMP_5.$$s || this, $a, $b, TMP_6;
if (row == null) row = nil;if (r == null) r = nil;
        result = result['$+'](((8)['$-'](r)).$to_s()['$+'](" "));
          ($a = ($b = row).$each_with_index, $a.$$p = (TMP_6 = function(piece, c){var self = TMP_6.$$s || this, $a, text_color = nil, background = nil, str = nil;
if (piece == null) piece = nil;if (c == null) c = nil;
          text_color = "white";
            background = (function() {if ((r['$+'](c))['$%'](2)['$=='](0)) {
              return "blue"
              } else {
              return "light_blue"
            }; return nil; })();
            if ([r, c]['$=='](options['$[]']("cursor_pos"))) {
              text_color = "red"};
            if ((($a = options['$[]']("moves")['$include?']([r, c])) !== nil && (!$a.$$is_boolean || $a == true))) {
              background = "cyan"};
            str = ((function() {if ((($a = (piece['$nil?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
              return "_"
              } else {
              return piece.$to_s()
            }; return nil; })())['$+'](" ");
            result = result['$+'](str);
            return result = result['$+']("");}, TMP_6.$$s = self, TMP_6), $a).call($b);
          return result = result['$+']("\n");}, TMP_5.$$s = self, TMP_5), $a).call($b);
        result = result['$+']("\n");
        result = result['$+']("   key: action\n");
        result = result['$+']("—————————————————————\n");
        result = result['$+']("arrows: move cursor\n");
        result = result['$+'](" enter: select\n");
        result = result['$+']("     c: cancel\n");
        result = result['$+']("     q: quit\n");
        result = result['$+']("\n");
        return result;
      };
      ...
      def['$[]='] = function(r, c, piece) {
        var $a, $b, self = this;

        self.$grid()['$[]'](r)['$[]='](c, piece);
        if ((($a = piece['$nil?']()['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return (($a = [[r, c]]), $b = piece, $b['$pos='].apply($b, $a), $a[$a.length-1])
          } else {
          return nil
        };
      };

      def.$pieces = function(color) {
        var $a, $b, TMP_7, self = this;

        if (color == null) {
          color = nil
        }
        return ($a = ($b = self.$grid().$flatten().$compact()).$select, $a.$$p = (TMP_7 = function(piece){var self = TMP_7.$$s || this, $a;
if (piece == null) piece = nil;
        return ((($a = color['$nil?']()) !== false && $a !== nil) ? $a : (color['$=='](piece.$color())))}, TMP_7.$$s = self, TMP_7), $a).call($b);
      };

      def.$move = function(start, end_pos, color) {
        var $a, self = this, piece = nil;

        piece = ($a = self)['$[]'].apply($a, [].concat(start));
        self.$validate_move(color, piece, end_pos);
        return self['$move!'](start, end_pos);
      };

      def.$promote_pawns = function() {
        var $a, $b, TMP_8, self = this;

        return ($a = ($b = [["white", 0], ["black", 7]]).$each, $a.$$p = (TMP_8 = function(color, r){var self = TMP_8.$$s || this, $a, $b, TMP_9;
if (color == null) color = nil;if (r == null) r = nil;
        return ($a = ($b = self.$grid()['$[]'](r)).$each_with_index, $a.$$p = (TMP_9 = function(piece, c){var self = TMP_9.$$s || this, $a;
if (piece == null) piece = nil;if (c == null) c = nil;
          if ((($a = piece['$is_a?']($scope.get('Pawn'))) !== nil && (!$a.$$is_boolean || $a == true))) {
              return self['$[]='](r, c, $scope.get('Queen').$new(self, color))
              } else {
              return nil
            }}, TMP_9.$$s = self, TMP_9), $a).call($b)}, TMP_8.$$s = self, TMP_8), $a).call($b);
      };

      def.$validate_move = function(color, piece, end_pos) {
        var $a, $b, $c, TMP_10, self = this, test_move_board = nil;

        if ((($a = piece['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('InvalidMoveError').$new("No piece there."))
        } else if ((($a = piece.$moves()['$include?'](end_pos)['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('InvalidMoveError').$new("Not in the " + (piece.$class()) + "'s moveset."))
        } else if ((($a = ($b = ($c = end_pos)['$all?'], $b.$$p = (TMP_10 = function(v){var self = TMP_10.$$s || this;
if (v == null) v = nil;
        return ($range(0, 8, true))['$include?'](v)}, TMP_10.$$s = self, TMP_10), $b).call($c)['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('InvalidMoveError').$new("Can't move off the board. This is probably a bug."));
          self.$exit();
        } else if ((($a = color['$=='](piece.$color())['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('InvalidMoveError').$new("Can't move opponent's piece."))};
        test_move_board = self.$dup();
        test_move_board['$move!'](piece.$pos(), end_pos);
        if ((($a = test_move_board['$in_check?'](piece.$color())) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('InvalidMoveError').$new("Not allowed to move into check"))};
        return true;
      };

      def['$move!'] = function(start, end_pos) {
        var $a, $b, $c, self = this, piece = nil;

        piece = ($a = self)['$[]'].apply($a, [].concat(start));
        ($b = self)['$[]='].apply($b, [].concat(start).concat(nil));
        ($c = self)['$[]='].apply($c, [].concat(end_pos).concat(piece));
        return nil;
      };

      def['$in_check?'] = function(color) {
        var $a, $b, TMP_11, $c, TMP_12, self = this, our_king = nil;

        our_king = ($a = ($b = self.$pieces(color)).$find, $a.$$p = (TMP_11 = function(piece){var self = TMP_11.$$s || this;
if (piece == null) piece = nil;
        return piece['$is_a?']($scope.get('King'))}, TMP_11.$$s = self, TMP_11), $a).call($b);
        return ($a = ($c = self.$pieces(self.$other_color(color)))['$any?'], $a.$$p = (TMP_12 = function(piece){var self = TMP_12.$$s || this;
if (piece == null) piece = nil;
        return piece.$moves()['$include?'](our_king.$pos())}, TMP_12.$$s = self, TMP_12), $a).call($c);
      };

      def['$stalemate?'] = function(color) {
        var $a, $b, TMP_13, self = this;

        if (self.$pieces().$count()['$<='](2)) {
          return true};
        return ($a = ($b = self.$pieces(color))['$all?'], $a.$$p = (TMP_13 = function(piece){var self = TMP_13.$$s || this;
if (piece == null) piece = nil;
        return piece.$moves()['$empty?']()}, TMP_13.$$s = self, TMP_13), $a).call($b);
      };

      def['$checkmate?'] = function(color) {try {

        var $a, $b, TMP_14, self = this;

        if ((($a = self['$in_check?'](color)['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return false};
        ($a = ($b = self.$pieces(color)).$each, $a.$$p = (TMP_14 = function(piece){var self = TMP_14.$$s || this, $a, $b, TMP_15;
if (piece == null) piece = nil;
        return ($a = ($b = piece.$moves()).$each, $a.$$p = (TMP_15 = function(new_pos){var self = TMP_15.$$s || this, $a, dup_board = nil;
if (new_pos == null) new_pos = nil;
          dup_board = self.$dup();
            dup_board['$move!'](piece.$pos(), new_pos);
            if ((($a = dup_board['$in_check?'](color)['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              Opal.ret(false)
              } else {
              return nil
            };}, TMP_15.$$s = self, TMP_15), $a).call($b)}, TMP_14.$$s = self, TMP_14), $a).call($b);
        return true;
        } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
      };

      return (def.$dup = function() {
        var $a, $b, TMP_16, self = this, dup_board = nil;

        dup_board = $scope.get('Board').$new($hash2(["blank"], {"blank": true}));
        ($a = ($b = self.$pieces()).$each, $a.$$p = (TMP_16 = function(piece){var self = TMP_16.$$s || this, $a;
if (piece == null) piece = nil;
        return ($a = dup_board)['$[]='].apply($a, [].concat(piece.$pos()).concat(piece.$class().$new(dup_board, piece.$color())))}, TMP_16.$$s = self, TMP_16), $a).call($b);
        return dup_board;
      }, nil) && 'dup';
    })(self, null)
  })(self)
...
/* Generated by Opal 0.7.1 */
Opal.modules["piece.rb"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  ...
  Opal.add_stubs(['$attr_accessor', '$dup', '$move!', '$pos', '$in_check?', '$color', '$to_s', '$each', '$map', '$*', '$pairwise_add', '$!', '$all?', '$include?', '$nil?', '$[]', '$board', '$==', '$<<', '$move_dirs', '$+', '$-']);
  return (function($base) {
    var self = $module($base, 'Chess');
    ...
    (function($base, $super) {
      ...
      def.board = nil;
      self.$attr_accessor("pos", "board", "color");

      def.$initialize = function(board, color) {
        var self = this;
      ...
      def['$move_into_check?'] = function(pos) {
        var self = this, dup_board = nil;

        dup_board = self.board.$dup();
        dup_board['$move!'](self.$pos(), pos);
        return dup_board['$in_check?'](self.$color());
      };

      return (def.$inspect = function() {
        var self = this;

        return "(" + (self.$color()) + " " + (self.$to_s()) + "  at " + (self.$pos()) + ")";
      }, nil) && 'inspect';
    })(self, null);

    (function($base, $super) {
      function $SlidingPiece(){};
      var self = $SlidingPiece = $klass($base, $super, 'SlidingPiece', $SlidingPiece);

      var def = self.$$proto, $scope = self.$$scope;

      return (def.$moves = function() {
        var $a, $b, TMP_1, self = this, result = nil;

        result = [];
        ($a = ($b = self.$move_dirs()).$each, $a.$$p = (TMP_1 = function(dir){var self = TMP_1.$$s || this, $a, $b, TMP_2, pos = nil;
if (dir == null) dir = nil;
        pos = self.$pos();
          return ($a = ($b = ($range(1, 8, false))).$each, $a.$$p = (TMP_2 = function(magnitude){var self = TMP_2.$$s || this, $a, $b, TMP_3, $c, $d, TMP_4, $e, $f, $g, $h, motion = nil, new_pos = nil;
if (magnitude == null) magnitude = nil;
          motion = ($a = ($b = dir).$map, $a.$$p = (TMP_3 = function(v){var self = TMP_3.$$s || this;
if (v == null) v = nil;
            return v['$*'](magnitude)}, TMP_3.$$s = self, TMP_3), $a).call($b);
            new_pos = self.$pairwise_add(self.$pos(), motion);
            if ((($a = (($c = ($d = new_pos)['$all?'], $c.$$p = (TMP_4 = function(v){var self = TMP_4.$$s || this;
if (v == null) v = nil;
            return ($range(0, 8, true))['$include?'](v)}, TMP_4.$$s = self, TMP_4), $c).call($d))['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              return ($breaker.$v = nil, $breaker)};
            if ((($a = ($c = (($e = self.$board())['$[]'].apply($e, [].concat(new_pos))['$nil?']())['$!'](), $c !== false && $c !== nil ?($f = self.$board())['$[]'].apply($f, [].concat(new_pos)).$color()['$=='](self.$color()) : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
              return ($breaker.$v = nil, $breaker)};
            if ((($a = ($c = (($g = self.$board())['$[]'].apply($g, [].concat(new_pos))['$nil?']())['$!'](), $c !== false && $c !== nil ?($h = self.$board())['$[]'].apply($h, [].concat(new_pos)).$color()['$=='](self.$color())['$!']() : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
              result['$<<'](new_pos);
              return ($breaker.$v = nil, $breaker);};
            return result['$<<'](new_pos);}, TMP_2.$$s = self, TMP_2), $a).call($b);}, TMP_1.$$s = self, TMP_1), $a).call($b);
        return result;
      }, nil) && 'moves'
    })(self, $scope.get('Piece'));
    ...
    (function($base, $super) {
      function $SteppingPiece(){};
      var self = $SteppingPiece = $klass($base, $super, 'SteppingPiece', $SteppingPiece);
      ...
      return (def.$moves = function() {
        ...
        result = [];
        ($a = ($b = self.$move_dirs()).$each, $a.$$p = (TMP_5 = function(dir){var self = TMP_5.$$s || this, $a, $b, $c, TMP_6, pos = nil, new_pos = nil, r = nil, c = nil;
if (dir == null) dir = nil;
        pos = self.$pos();
          new_pos = self.$pairwise_add(self.$pos(), dir);
          $a = Opal.to_ary(new_pos), r = ($a[0] == null ? nil : $a[0]), c = ($a[1] == null ? nil : $a[1]);
          if ((($a = (($b = ($c = new_pos)['$all?'], $b.$$p = (TMP_6 = function(v){var self = TMP_6.$$s || this;
if (v == null) v = nil;
          return ($range(0, 8, true))['$include?'](v)}, TMP_6.$$s = self, TMP_6), $b).call($c))['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            return nil;};
          if ((($a = ($b = (self.$board()['$[]'](r, c)['$nil?']())['$!'](), $b !== false && $b !== nil ?self.$board()['$[]'](r, c).$color()['$=='](self.$color()) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            return nil;};
          return result['$<<'](new_pos);}, TMP_5.$$s = self, TMP_5), $a).call($b);
        return result;
      }, nil) && 'moves'
    })(self, $scope.get('Piece'));
    ...
    (function($base, $super) {
      ...
      def.$moves = function() {
        var $a, $b, $c, self = this, result = nil, r = nil, c = nil, sign = nil;

        result = [];
        $a = Opal.to_ary(self.$pos()), r = ($a[0] == null ? nil : $a[0]), c = ($a[1] == null ? nil : $a[1]);
        sign = (function() {if ((($a = (self.$color()['$==']("white"))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return -1
          } else {
          return 1
        }; return nil; })();
        if ((($a = ($range(0, 8, true))['$include?'](r['$+'](sign))['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return []};
        if ((($a = self.$board()['$[]'](r['$+'](sign), c)['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          result['$<<']([r['$+'](sign), c])};
        if ((($a = ((($b = self.$board()['$[]'](r['$+'](sign), c['$-'](1))['$nil?']()) !== false && $b !== nil) ? $b : self.$board()['$[]'](r['$+'](sign), c['$-'](1)).$color()['$=='](self.$color()))) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          result['$<<']([r['$+'](sign), c['$-'](1)])
        };
        if ((($a = ((($b = self.$board()['$[]'](r['$+'](sign), c['$+'](1))['$nil?']()) !== false && $b !== nil) ? $b : self.$board()['$[]'](r['$+'](sign), c['$+'](1)).$color()['$=='](self.$color()))) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        if ((($a = ((($b = ((($c = self.$color()['$==']("white")) ? r['$=='](6) : $c))) !== false && $b !== nil) ? $b : ((($c = self.$color()['$==']("black")) ? r['$=='](1) : $c)))) !== nil && (!$a.$$is_boolean || $a == true))) {
          if ((($a = ($b = self.$board()['$[]'](r['$+'](sign['$*'](2)), c)['$nil?'](), $b !== false && $b !== nil ?self.$board()['$[]'](r['$+'](sign), c)['$nil?']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            result['$<<']([r['$+'](sign['$*'](2)), c])}};
        return result;
      };
...
/* Generated by Opal 0.7.1 */
Opal.modules["game.rb"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$attr_accessor', '$board=', '$new', '$loop', '$puts', '$board', '$players', '$stalemate?', '$color', '$checkmate?', '$name', '$in_check?', '$play_turn', '$reverse!', '$promote_pawns', '$message']);
  return (function($base) {
    var self = $module($base, 'Chess');
    ...
    (function($base, $super) {
      ...
      self.$attr_accessor("players", "board");

      def.$initialize = function(player1, player2) {
        var $a, $b, $c, $d, self = this;

        self.players = [player1, player2];
        return (($a = [(($c = [self.board = $scope.get('Board').$new()]), $d = player2, $d['$board='].apply($d, $c), $c[$c.length-1])]), $b = player1, $b['$board='].apply($b, $a), $a[$a.length-1]);
      };

      return (def.$play = function() {try {

        var $a, $b, TMP_1, self = this;

        return ($a = ($b = self).$loop, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $a, current_player = nil, next_player = nil, e = nil;

        try {
          self.$puts(self.$board());
            $a = Opal.to_ary(self.$players()), current_player = ($a[0] == null ? nil : $a[0]), next_player = ($a[1] == null ? nil : $a[1]);
            if ((($a = self.$board()['$stalemate?'](current_player.$color())) !== nil && (!$a.$$is_boolean || $a == true))) {
              self.$puts("Stalemate! Nobody wins!");
              return ($breaker.$v = nil, $breaker);
            } else if ((($a = self.$board()['$checkmate?'](current_player.$color())) !== nil && (!$a.$$is_boolean || $a == true))) {
              self.$puts("Checkmate! " + (next_player.$name()) + " (" + (next_player.$color()) + ") won!");
              return ($breaker.$v = nil, $breaker);
            } else if ((($a = self.$board()['$in_check?'](current_player.$color())) !== nil && (!$a.$$is_boolean || $a == true))) {
              self.$puts("You are in check.")};
            current_player.$play_turn();
            self.$players()['$reverse!']();
            return self.$board().$promote_pawns();
          } catch ($err) {if (Opal.rescue($err, [$scope.get('InvalidMoveError')])) {e = $err;
            return self.$puts(e.$message())
            }else if (Opal.rescue($err, [$scope.get('NoMovesError')])) {e = $err;
            self.$puts(e.$message());
            Opal.ret(nil);
            }else { throw $err; }
          }}, TMP_1.$$s = self, TMP_1), $a).call($b);
...
/* Generated by Opal 0.7.1 */
Opal.modules["player.rb"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$attr_accessor', '$move', '$board', '$get_move', '$color', '$loop', '$get_start_pos', '$nil?', '$get_end_pos', '$private', '$dup', '$puts', '$to_s', '$getch', '$===', '$exit', '$[]', '$!', '$==', '$[]=', '$-', '$+', '$all?', '$between?', '$moves', '$sample', '$reject', '$empty?', '$select', '$validate_move', '$pieces', '$raise', '$new', '$name', '$pos']);
  return (function($base) {
    var self = $module($base, 'Chess');
    ...
    (function($base, $super) {
      ...
      self.$attr_accessor("board", "color", "name", "move_counter");

      def.$initialize = function(name, color) {
        var self = this;
      ...
      return (def.$play_turn = function() {
        var $a, self = this;

        return ($a = self.$board()).$move.apply($a, [].concat(self.$get_move()).concat(self.$color()));
      }, nil) && 'play_turn';
    })(self, null);

    (function($base, $super) {
      function $HumanPlayer(){};
      var self = $HumanPlayer = $klass($base, $super, 'HumanPlayer', $HumanPlayer);

      var def = self.$$proto, $scope = self.$$scope, TMP_1;

      def.$initialize = TMP_1 = function(name, color) {var $zuper = $slice.call(arguments, 0);
        var self = this, $iter = TMP_1.$$p, $yield = $iter || nil;

        TMP_1.$$p = null;
        Opal.find_super_dispatcher(self, 'initialize', TMP_1, $iter).apply(self, $zuper);
        return self.cursor_pos = [0, 0];
      };

      def.$get_move = function() {try {

        var $a, $b, TMP_2, self = this;

        return ($a = ($b = self).$loop, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $a, start_pos = nil, end_pos = nil;

        start_pos = self.$get_start_pos();
          if ((($a = start_pos['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            return nil;};
          end_pos = self.$get_end_pos(start_pos);
          Opal.ret([start_pos, end_pos]);}, TMP_2.$$s = self, TMP_2), $a).call($b);
        } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
      };

      self.$private();

      def.$get_start_pos = function() {try {

        var $a, $b, TMP_3, self = this;

        return ($a = ($b = self).$loop, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $a, $b, $c, $d, TMP_4, new_cursor_pos = nil, $case = nil, piece = nil;
          if (self.cursor_pos == null) self.cursor_pos = nil;

        new_cursor_pos = self.cursor_pos.$dup();
          self.$puts(self.$board().$to_s($hash2(["cursor_pos"], {"cursor_pos": self.cursor_pos})));
          $case = $scope.get('STDIN').$getch();if ("q"['$===']($case)) {self.$exit()}else if ("\r"['$===']($case)) {piece = ($a = self.$board())['$[]'].apply($a, [].concat(new_cursor_pos));
          if ((($b = ((($c = piece['$nil?']()) !== false && $c !== nil) ? $c : piece.$color()['$=='](self.$color())['$!']())) !== nil && (!$b.$$is_boolean || $b == true))) {
            return nil;};
          Opal.ret(self.cursor_pos);}else if ("\e"['$===']($case)) {$scope.get('STDIN').$getch();
          $case = $scope.get('STDIN').$getch();if ("A"['$===']($case)) {($b = 0, $c = new_cursor_pos, $c['$[]=']($b, $c['$[]']($b)['$-'](1)))}else if ("B"['$===']($case)) {($b = 0, $c = new_cursor_pos, $c['$[]=']($b, $c['$[]']($b)['$+'](1)))}else if ("C"['$===']($case)) {($b = 1, $c = new_cursor_pos, $c['$[]=']($b, $c['$[]']($b)['$+'](1)))}else if ("D"['$===']($case)) {($b = 1, $c = new_cursor_pos, $c['$[]=']($b, $c['$[]']($b)['$-'](1)))};};
          if ((($b = ($c = ($d = new_cursor_pos)['$all?'], $c.$$p = (TMP_4 = function(pos){var self = TMP_4.$$s || this;
if (pos == null) pos = nil;
          return pos['$between?'](0, 7)}, TMP_4.$$s = self, TMP_4), $c).call($d)) !== nil && (!$b.$$is_boolean || $b == true))) {
            return self.cursor_pos = new_cursor_pos
            } else {
            return nil
      ...
      def.$get_end_pos = function(start_pos) {try {

        var $a, $b, $c, TMP_5, self = this, piece = nil;

        piece = ($a = self.$board())['$[]'].apply($a, [].concat(start_pos));
        self.cursor_pos = start_pos.$dup();
        return ($b = ($c = self).$loop, $b.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $a, $b, $c, TMP_6, new_cursor_pos = nil, $case = nil;
          if (self.cursor_pos == null) self.cursor_pos = nil;

        new_cursor_pos = self.cursor_pos.$dup();
          self.$puts(self.$board().$to_s($hash2(["cursor_pos", "moves"], {"cursor_pos": self.cursor_pos, "moves": piece.$moves()})));
          $case = $scope.get('STDIN').$getch();if ("q"['$===']($case)) {self.$exit()}else if ("c"['$===']($case)) {Opal.ret(nil);
          return ($breaker.$v = nil, $breaker);}else if ("\r"['$===']($case)) {Opal.ret(self.cursor_pos)}else if ("\e"['$===']($case)) {$scope.get('STDIN').$getch();
          $case = $scope.get('STDIN').$getch();if ("A"['$===']($case)) {($a = 0, $b = new_cursor_pos, $b['$[]=']($a, $b['$[]']($a)['$-'](1)))}else if ("B"['$===']($case)) {($a = 0, $b = new_cursor_pos, $b['$[]=']($a, $b['$[]']($a)['$+'](1)))}else if ("C"['$===']($case)) {($a = 1, $b = new_cursor_pos, $b['$[]=']($a, $b['$[]']($a)['$+'](1)))}else if ("D"['$===']($case)) {($a = 1, $b = new_cursor_pos, $b['$[]=']($a, $b['$[]']($a)['$-'](1)))};};
          if ((($a = ($b = ($c = new_cursor_pos)['$all?'], $b.$$p = (TMP_6 = function(pos){var self = TMP_6.$$s || this;
if (pos == null) pos = nil;
          return pos['$between?'](0, 7)}, TMP_6.$$s = self, TMP_6), $b).call($c)) !== nil && (!$a.$$is_boolean || $a == true))) {
            return self.cursor_pos = new_cursor_pos
            } else {
            return nil
          };}, TMP_5.$$s = self, TMP_5), $b).call($c);
        } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
      };

      return self.$attr_accessor("cursor_pos");
    })(self, $scope.get('Player'));

    (function($base, $super) {
      function $ComputerPlayer(){};
      var self = $ComputerPlayer = $klass($base, $super, 'ComputerPlayer', $ComputerPlayer);

      var def = self.$$proto, $scope = self.$$scope;

      return (def.$get_move = function() {
        var $a, $b, TMP_7, self = this, piece = nil, start_pos = nil, end_pos = nil;

        piece = ($a = ($b = self.$board().$pieces(self.$color())).$reject, $a.$$p = (TMP_7 = function(piece){var self = TMP_7.$$s || this, $a, $b, TMP_8;
if (piece == null) piece = nil;
        return ($a = ($b = piece.$moves()).$select, $a.$$p = (TMP_8 = function(pos){var self = TMP_8.$$s || this, e = nil;
if (pos == null) pos = nil;
          try {
            self.$board().$validate_move(self.$color(), piece, pos);
              return true;
            } catch ($err) {if (Opal.rescue($err, [$scope.get('InvalidMoveError')])) {e = $err;
              return false
              }else { throw $err; }
            }}, TMP_8.$$s = self, TMP_8), $a).call($b)['$empty?']()}, TMP_7.$$s = self, TMP_7), $a).call($b).$sample();
        if ((($a = piece['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('NoMovesError').$new("There are no moves left for " + (self.$name()) + " (" + (self.$color()) + ")"))};
        start_pos = piece.$pos();
...
/* Generated by Opal 0.7.1 */
Opal.modules["helpers.rb"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$==', '$map', '$reduce', '$zip']);
  return (function($base) {
    var self = $module($base, 'Chess');
    ...
    (function($base, $super) {
      function $NoMovesError(){};
      var self = $NoMovesError = $klass($base, $super, 'NoMovesError', $NoMovesError);
    ...
    Opal.defn(self, '$other_color', function(color) {
      var $a, self = this;

      if ((($a = (color['$==']("white"))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return "black"
        } else {
        return "white"
      };
    ...
    Opal.defn(self, '$pairwise_add', function(arr1, arr2) {
      var $a, $b, TMP_1, self = this;

      return ($a = ($b = arr1.$zip(arr2)).$map, $a.$$p = (TMP_1 = function(pair){var self = TMP_1.$$s || this;
if (pair == null) pair = nil;
      return pair.$reduce("+")}, TMP_1.$$s = self, TMP_1), $a).call($b);
    });
  })(self)
};
...
(function(Opal) {
  Opal.dynamic_require_severity = "error";
  var $a, $b, TMP_1, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, davide = nil, peter = nil, c1 = nil, c2 = nil;

  Opal.add_stubs(['$include', '$new', '$loop', '$play']);
  self.$require("chess.rb"+ '/../' + "board.rb");
  self.$require("chess.rb"+ '/../' + "piece.rb");
  self.$require("chess.rb"+ '/../' + "game.rb");
  self.$require("chess.rb"+ '/../' + "player.rb");
  self.$require("chess.rb"+ '/../' + "helpers.rb");
  self.$include($scope.get('Chess'));
  davide = $scope.get('HumanPlayer').$new("Davide", "white");
  peter = $scope.get('HumanPlayer').$new("Peter", "black");
  c1 = $scope.get('ComputerPlayer').$new("ShallowBlue", "black");
  c2 = $scope.get('ComputerPlayer').$new("Tiny Robot", "white");
  return ($a = ($b = self).$loop, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, g = nil;

  g = $scope.get('Game').$new(c1, c2);
    return g.$play();}, TMP_1.$$s = self, TMP_1), $a).call($b);
})(Opal);
